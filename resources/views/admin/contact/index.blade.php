...
<body class="bg-you-grey flex items-center justify-center h-full">
    <form method="POST" action="/mailcontact" class="bg-white p-6 rounded shadow-md" style="width: 300px">
        @csrf
