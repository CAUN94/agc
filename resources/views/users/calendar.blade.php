                ...
                <div class="border-4 border-primary-500 border-current">
                  <div class="bg-white text-sm px-4 py-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-6 overflow-y-scroll">
                    <div class="flex justify-between items-center">
                      ...
                      <span class="text-base text-primary-500 mb-2">
      ...
      <div class="bg-gray-50 shadow overflow-hidden sm:rounded-lg ">
        <div class="flex px-4 py-3 sm:px-6 ">
          <div class="flex flex-col items-center w-full">
            <div class="text-lg leading-6 font-medium text-primary-500 flex items-center">
              Métodos de pago: Crédito / Débito <img class="h-14 w-14" src="{{ asset('/img/mp.png') }}">
            </div>
            <a class="text-lg mt-2 leading-6 font-medium you-grey" href="https://api.whatsapp.com/send?phone=56933809726&text=Hola!" >
