...
<div class="container mx-auto mt-4">
    ...
    <div class="flex-col sm:flex-row flex gap-4">
        ...
        <div class="w-full order-2 sm:order-1 sm:w-2/5 bg-gray-50 shadow overflow-hidden sm:rounded-lg">
          <div class="flex px-4 py-5 sm:px-6 justify-between">
            <div class="flex flex-col">
              <h3 class="text-lg leading-6 font-medium text-primary-500">
                {{ $user->fullName() }}
        ...
        <div class="w-full order-1 sm:order-2 sm:w-2/5 flex flex-col gap-y-4">
