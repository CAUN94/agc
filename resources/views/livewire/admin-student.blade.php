          ...
          <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div>
                <div class="bg-white shadow overflow-hidden sm:rounded-t-md">
                  ...
                  <div class="border border-y-4 bg-gray-200">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Planes Inscritos</h3>
                    </div>
                  </div>
                                                ...
                                                <div class="flex items-center">
                                                        <div>
                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                {{$plan->Training->planComplete()}}
                                                            </p>
                                                        </div>
                                                    </div>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{{$plan->Training->price()}}</p>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">
                                                    {{date('d M Y', strtotime($plan->start_day ))}}
                                                </p>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                                    ...
                                                    {{ $plan->isSettled() ? "text-green-900" : "text-red-900" }}
                                                    leading-tight">
                                                    <span aria-hidden
                                                        class="absolute inset-0
                                                        {{ $plan->isSettled() ? "bg-green-200" : "bg-red-200" }}
                                                        opacity-50 rounded-full"></span>
                                                    <span class="relative">
                                                        {{ $plan->isSettled() ? "Pagado" : "Pendiente" }}
                                                    </span>
                                                </span>
