<div class="flex gap-2">
    <div class="w-1/4 flex flex-col overflow-x-auto gap-y-2">
                            ...
                            <div class="-mx-1 -mb-1">
                                ...
                                <div class="flex flex-wrap border-t border-l">
                                    ...
                                    @foreach($dates as $date)
                                        <div style="width: {{$width}}; height: {{$height}}" class="px-4 pt-2 border-r border-b relative
                                        ...
                                        ">
                                            ...
                                            @if (Auth::user()->student->islastday($date))
                                                @if(Auth::user()->student->islastday($date)->isRenew())
                                                    <span class="text-sm">Fin de Plan</span>
                                                @else
                                                    <span class="box-class border-primary-200 text-sm bg-primary-100 hover:bg-green-100 cursor-pointer">Renovar Plan</span>
                                                @endif
                                            @endif

                                            @if(Auth::user()->student->isStartday($date))
                                                <span class="text-sm">Inicio Plan</span>
                                            @endif
