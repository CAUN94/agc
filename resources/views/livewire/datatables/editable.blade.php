<div x-data="{
    ...
    <button class="min-h-[28px] w-full text-left hover:bg-primay-100 px-2 py-1 -mx-2 -my-1 rounded focus:outline-none" x-bind:class="{ 'text-primary-500': edited }" x-show="!edit"
