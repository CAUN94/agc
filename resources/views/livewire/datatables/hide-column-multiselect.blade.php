<div x-data="{ show: false }" class="flex flex-col items-center">
    <div class="flex flex-col items-center relative">
        <button x-on:click="show = !show" class="px-3 py-2 border border-primary-500 rounded-md bg-white text-primary-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-primary-100 focus:outline-none">
            <div class="flex items-center h-5">
                {{ __('Mostrar / Ocultar Columnas')}}
            </div>
        </button>
