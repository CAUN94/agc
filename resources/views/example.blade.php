<x-landing.layout>
<div class="bg-primary-100 h-screen flex flex-col justify-center items-center">
   ...
   >
    ...
    <template x-for="slide in slides" :key="slide">
      <div
         ...
         class="p-24 font-bold text-5xl h-64 flex items-center bg-primary-500 text-white rounded-lg">
    ...
    <div class="absolute w-full flex items-center justify-center px-4">
      <template x-for="slide in slides" :key="slide">
        <button
          class="flex-1 w-4 h-2 mt-4 mx-2 mb-0 rounded-full overflow-hidden transition-colors duration-200 ease-out hover:bg-primary-600 hover:shadow-lg"
          :class="{
              'bg-orange-600': activeSlide === slide,
              'bg-primary-300': activeSlide !== slide
          }"
