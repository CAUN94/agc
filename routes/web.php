...
|--------------------------------------------------------------------------
|
| Here is where you can register web routes for your application. Thefe
...
Route::middleware([UpdatePassword::class,])->group(function () {
    ...
    Route::get('/precios', [LandingController::class, 'precios']);
    Route::get('/contactanos', [LandingController::class, 'contactanos']);
    ...
    Route::get('appointmentConfirm', [AdminTrainAppointmentsController::class, 'confirmTrainAppointment'])->middleware(['intranet']);
    ...
    Route::get('/youagendate', 'App\Http\Controllers\RedirectController@youagendate');
